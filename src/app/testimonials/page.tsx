                        ...
                        <div className="space-y-32">
                            <figure className="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5">
                                ...
                                <figcaption className="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-gray-900/10 px-6 py-4 sm:flex-nowrap">
                                    <Link href="https://sjogdublinsoutheastservices.ie/" target="_blank">
                            ...
                            <figure className="rounded-2xl h-thirdFigureFit bg-white shadow-lg ring-1 ring-gray-900/5">
                                ...
                                <figcaption className="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-gray-900/10 px-6 py-4 sm:flex-nowrap">
                                    <Link href="https://childvision.ie/" target="_blank">
                            ...
                            <figure className="rounded-2xl h-thirdFigureFit bg-white shadow-lg ring-1 ring-gray-900/5">
                                ...
                                <figcaption className="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-gray-900/10 px-6 py-4 sm:flex-nowrap">
                                    <Link href="https://thelearningtree.ie/" target="_blank">
                                    ...
                                    <div className="flex-auto">
                                        ...
                                        <div className="text-gray-600">{"Board Member, The Learning Tree, Integrated Creche and Montessori"}</div>
                                    </div>
                                </figcaption>
                            </figure>
